...
def generate_adversarial_sample(image_path: str,
    ...
    inputs_turn = 2 * inputs - 1
    targets = model(inputs_turn.half().to(device)).latent_dist.mean
...
def main():
    ...
    image_files = image_files[100:106]
    f = 0
    ...
    #for i in range(1):
        ...
        adversarial_sample = generate_adversarial_sample(image_path, targets=None, model=pipe_img2img.vae.encode,)
