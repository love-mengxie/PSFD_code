...
def main():
    ...
    attack_folder = "./adv/ab_s"
    edit_image_folder = "./resultsori"
    #image_folder = "./imagenet/imagenet/imagenet/GT6"
    #ref_folder = "./imagenet/imagenet/imagenet/ref"
    #mask_folder = "./imagenet/imagenet/imagenet/mask"
    #attack_folder = "./adv/photoguard_wo"
