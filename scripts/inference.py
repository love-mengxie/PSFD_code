...
safety_feature_extractor = AutoFeatureExtractor.from_pretrained("/root/autodl-tmp/safety-checker")
safety_checker = StableDiffusionSafetyChecker.from_pretrained("/root/autodl-tmp/safety-checker")
